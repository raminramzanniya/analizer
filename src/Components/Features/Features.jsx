    ...
    <div className='Container-Features'>
        <div className="Features-Section">
            ...
            <div className="Features-Profit">
                <span className="Features-Profit__Money">$273</span>
                <span className="Features-Profit__Arrow">-2.27 <ArrowDownOutlined className='Negetive'/></span>
            </div>
        ...
        <div className="Features-Section">
            ...
            <div className="Features-Profit">
                <span className="Features-Profit__Money">$1,537</span>
        ...
        <div className="Features-Section">
            ...
            <div className="Features-Profit">
                <span className="Features-Profit__Money">$2,987</span>
